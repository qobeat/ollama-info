# Bash integration for ollama-info v1.7
...
ollama bench qwen3.6   # auto-route to generation or embedding benchmark by model role
ollama test qwen3.6    # strict generation benchmark/monitor with safe defaults
