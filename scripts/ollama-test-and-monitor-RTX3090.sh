...
VERSION="1.10.0"
SCRIPT_SIGNATURE="OLLAMA_TEST_AND_MONITOR_RTX3090_SCRIPT_SIGNATURE=v1.10-mode-complete-settings-tuning"
...
for f in summary.md terminal-summary.txt model-scorecard.csv recommendations.md performance-settings.md performance-settings.sh environment-summary.md runner-log-facts.md capability-analysis.md; do
